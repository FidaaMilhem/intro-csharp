...
namespace lesson_22_data2 {
    ...
    public partial class MusicStore : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationCatProd;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationCatProd = this.Relations["CatProd"];
        }
        ...
        private void InitClass() {
            ...
            fkc = new global::System.Data.ForeignKeyConstraint("CatProd", new global::System.Data.DataColumn[] {
            ...
            this.relationCatProd = new global::System.Data.DataRelation("CatProd", new global::System.Data.DataColumn[] {
                        this.tableCategories.CategoryIDColumn}, new global::System.Data.DataColumn[] {
                        this.tableProducts.CategoryIDColumn}, false);
            this.relationCatProd.Nested = true;
            this.Relations.Add(this.relationCatProd);
        }
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, int SupplierID, CategoriesRow parentCategoriesRowByCatProd, string QuantityPerUnit, decimal UnitPrice, short UnitsInStock, short UnitsOnOrder, short ReorderLevel, bool Discontinued) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        ReorderLevel,
                        Discontinued};
                if ((parentCategoriesRowByCatProd != null)) {
                    columnValuesArray[3] = parentCategoriesRowByCatProd[0];
                }
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public CategoriesRow CategoriesRow {
                get {
                    return ((CategoriesRow)(this.GetParentRow(this.Table.ParentRelations["CatProd"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["CatProd"]);
                }
            }
        ...
        public partial class CategoriesRow : global::System.Data.DataRow {
            ...
            public ProductsRow[] GetProductsRows() {
                if ((this.Table.ChildRelations["CatProd"] == null)) {
                    return new ProductsRow[0];
                }
                else {
                    return ((ProductsRow[])(base.GetChildRows(this.Table.ChildRelations["CatProd"])));
                }
            }
        }
...
namespace lesson_22_data2.MusicStoreTableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=LAPTOP-M82Q1N4K\\SQLEXPRESS;Initial Catalog=Northwind;Integrated Secur" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT COUNT(*) FROM Products";
            ...
            this._commandCollection[2].CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" +
                ...
                " Products\r\nWHERE        (UnitsInStock < @x)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@x", global::System.Data.SqlDbType.SmallInt, 2, global::System.Data.ParameterDirection.Input, 0, 0, "UnitsInStock", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(MusicStore.ProductsDataTable dataTable) {
        ...
        public virtual MusicStore.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MusicStore.ProductsDataTable dataTable = new MusicStore.ProductsDataTable();
        ...
        public virtual int FillByLowThan(MusicStore.ProductsDataTable dataTable, global::System.Nullable<short> x) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((x.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((short)(x.Value));
            }
            else {
        ...
        public virtual MusicStore.ProductsDataTable GetDataByLowThan(global::System.Nullable<short> x) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((x.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((short)(x.Value));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByNoStock(MusicStore.ProductsDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual MusicStore.ProductsDataTable GetDataByNoStock() {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            MusicStore.ProductsDataTable dataTable = new MusicStore.ProductsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MusicStore.ProductsDataTable dataTable) {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(MusicStore.CategoriesDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual MusicStore.CategoriesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MusicStore.CategoriesDataTable dataTable = new MusicStore.CategoriesDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MusicStore.CategoriesDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
